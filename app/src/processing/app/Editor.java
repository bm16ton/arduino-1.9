...
private void deleteTempFile(File tempFile) {
        ...
        System.out.println(tr("DELETED Temporal File: " + tempFile.getPath()));
        }
        catch(Throwable t)
        {
            System.out.println(tr("Could not DELETE file: " + tempFile.getPath()));
        }
    }
...
//      request.setBuildCachePath(null);
      try {
        deleteTempFile(BaseNoGui.getCachePath());
        deleteTempFile(sketch.getBuildPath());
        File f = new File(sketch.getBuildPath().getAbsolutePath()); 
        f.mkdir();
 //       f.delete();
     } catch (IOException e) {
        System.err.println(e.getMessage());
